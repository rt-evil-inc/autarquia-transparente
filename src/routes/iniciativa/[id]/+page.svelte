...
<main class="container mx-auto px-4 py-8">
	<!-- Check if there are proposal documents to determine layout -->
	{#if proposalDocuments.length > 0}
		<!-- 2-column layout with PDF on the right -->
		<div class="flex gap-6 max-w-7xl mx-auto">
			<!-- Left column - Main content -->
			<div class="flex-1 max-w-4xl flex flex-col gap-6">
				<!-- Breadcrumb -->
				<nav>
	...
	{:else}
		<!-- Single column layout when no proposal documents -->
